 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44, -16, -3.60 }
...
// #define X_MIN_POS 5 => Fails due to SanityCheck.h line 630 X_MAX_LENGTH >= X_BED_SIZE. Needs to be set as an X offset in the slicer software
#define X_MIN_POS 0
#define Y_MIN_POS -5
#define Z_MIN_POS 0
